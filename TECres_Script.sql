...
Nombre NCHAR(20) PRIMARY KEY NOT NULL,
...
Apellido1 NCHAR(20) NOT NULL,
Apellido2 NCHAR(20) NOT NULL,
Nacionalidad NCHAR(20) NOT NULL,
Correo NCHAR(20) NOT NULL,
Usuario NCHAR(20) NOT NULL, 
Contrasena NCHAR(20) NOT NULL,
Perfil_Cliente NCHAR(20) NOT NULL,
...
ID INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
Precio INT NOT NULL,
Direccion_Exacta NCHAR(100) NOT NULL,
...
Descripcion NCHAR(100) NOT NULL,
Foto_Principal NCHAR(100) NOT NULL,
ID_Ubicacion INT NOT NULL,
Nombre_Inmueble NCHAR(20) NOT NULL,
...
Clasificacion NCHAR(15) NOT NULL,
...
Tipo_Anuncio NCHAR(20) NOT NULL,
...
@pCant_Banos INT,
@pCant_Parqueos INT,
@pDescripcion NCHAR(100),
@pFoto_Principal NCHAR(100),
@pID_Ubicacion INT,
@pNombre_Inmueble NCHAR(20),
@pCedula_Cliente INT
AS 
BEGIN
